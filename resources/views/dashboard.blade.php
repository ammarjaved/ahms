...
@section('content')
    <div class="row d-flex justify-content-center p-2">
        ...
        <div class="row  ">
            <div class="col-md-2 py-2 tet-center card my-1  rounded-0" style="background-color: #41b369 ; margin-left: 20px"
                style="     ">
    ...
    <div class="row bg-white my-2 mx-1 pl-1 py-3">
        ...
        <p>Now it’s <span id="date"></span> <span id="live-time"></span> <span id="day"></span>, welcome back to
            aero hostel management system</p>
    </div>
